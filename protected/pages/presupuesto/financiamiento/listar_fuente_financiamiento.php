...
class listar_fuente_financiamiento extends TPage
{
	...
	public function actualiza_listado($sender)
	{
        ...
        $sql="select f.cod_fuente_financiamiento, f.descripcion, p.monto,
              CONCAT(ramo,'-',generica,'-',especifica,'-',subespecifica) as codigo
              from presupuesto.fuentes_financiamiento f, presupuesto.presupuesto_ingresos p
              where ((f.cod_presupuesto_ingreso = p.cod_presupuesto_ingreso) and 
                     (f.cod_organizacion = p.cod_organizacion) and
                     (f.cod_organizacion = '$cod_organizacion') and (f.ano = '$ano'))
              order by codigo";
    ...
    public function imprimir_listado($sender, $param)
    {
        ...
        { // si la consulta trae resultados, entonces si se imprime
            ...
            $info_adicional= "Listado de Fuentes de Financiamiento. \n".
                             "Año: ".$ano;
            ...
            $pdf->SetTitle('Fuentes de Financiamiento.');
            $pdf->SetSubject('Listado de Fuentes de Financiamiento.');
            ...
            $pdf->Cell(0, 6, "Fuentes de Financiamiento del año ".$ano, 0, 1, '', 1);
            ...
            $pdf->Output("listado_fuentes_de_financiamiento_".$ano.".pdf",'D');
        }
    }
