...
class integrantes_pagos_personal extends TPage
{
...
public function agregar($sender,$param)//sin revisar
  ...
  // Param is a TDataGridEventParameter  which contains the item newly created
    ...
    {
     $this->Response->redirect($this->Service->constructUrl('nomina.reportes.nomina_historial_personal',array('ano'=>$this->Request['ano'])));
    }
}
