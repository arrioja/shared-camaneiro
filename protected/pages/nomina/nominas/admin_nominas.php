...
class admin_nominas extends TPage
{
    ...
    public function cargar()
    {
        ...
        $sql="select distinct n.cod,n.tipo_nomina, na.titulo,na.f_pago from nomina.nomina n inner join nomina.nomina_actual na on n.cod=na.cod where n.cod_organizacion='$cod_org' order by n.cod desc";
